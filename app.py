...
APP_VERSION='v2.0 Alpha 4 — RC16.17.5 — Carte Web téléphone plein écran'
...
/* RC16.17.5 — Mobile Map Fullscreen UX */
@media(max-width:700px){
  ...
  .mobile-map-page .map-scope-bar,.mobile-map-page .map-action-bar,.mobile-map-page .map-location-bar{position:absolute;z-index:700;top:10px;margin:0;display:flex;gap:7px;flex-wrap:nowrap;width:auto;background:transparent;padding:0}
  .mobile-map-page .map-scope-bar{left:10px}
  .mobile-map-page .map-action-bar{left:132px}
  .mobile-map-page .map-location-bar{right:10px}
  .mobile-map-page .map-filter-bar .btn{width:auto!important;min-width:0!important;padding:8px 10px!important;border-radius:999px!important;font-size:12px!important;line-height:1.1;white-space:nowrap;box-shadow:0 3px 12px rgba(16,43,28,.16);border:1px solid rgba(255,255,255,.75)}
  .mobile-map-page .map-scope-bar .btn:not(.active){display:none!important}
