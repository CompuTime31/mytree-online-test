...
def volunteer_trees():
 ...
 <style>
 @media(max-width:760px){.mobile-tree-list-v16151{display:block!important}.mobile-tree-tabs{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:8px 0 14px}.mobile-tree-tab{display:flex;min-height:58px;align-items:center;justify-content:center;text-decoration:none;border:1px solid var(--line);border-radius:14px;background:#fff;color:var(--deep);font-weight:800;text-align:center;padding:8px}.mobile-tree-tab.active{background:var(--green);color:#fff;border-color:var(--green)}.mobile-tree-card{padding:14px 10px}.mobile-tree-table-wrap{overflow:hidden;margin-top:12px}.mobile-tree-table{width:100%!important;min-width:0!important;table-layout:fixed}.mobile-tree-table th,.mobile-tree-table td{padding:13px 7px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.mobile-tree-table th:nth-child(1),.mobile-tree-table td:nth-child(1){width:27%}.mobile-tree-table th:nth-child(2),.mobile-tree-table td:nth-child(2){width:30%}.mobile-tree-table th:nth-child(3),.mobile-tree-table td:nth-child(3){width:36%}.mobile-tree-table th:nth-child(4),.mobile-tree-table td:nth-child(4){width:7%;text-align:center}.mobile-tree-table tr:not(:first-child){cursor:pointer}.mobile-tree-table td:last-child{font-size:25px;font-weight:700}.mobile-tree-table td:first-child{color:var(--green)}}
 </style>
